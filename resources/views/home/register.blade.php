            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">{{ __('Đăng ký tài khoản') }}</h5>
                  </div>

                  <form id="registerForm" class="row g-3" method="POST" action="{{route('postRegister')}}" novalidate>
                    @csrf
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Địa chỉ Email</label>
                      <div class="input-group">
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Xác nhận lại mật khẩu</label>
                      <div class="input-group">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">{{ __('Dăng ký') }}</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Chưa có tài khoản? <a href="{{route('login')}}">Tạo tài khoản</a></p>
                    </div>
                  </form>
