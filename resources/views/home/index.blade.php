        ...
        <div class="col-md-9" data-aos="fade-up">
            ...
            <div class="d-md-flex post-entry-2 half">
                ...
                <div>
                    ...
                    @php
                    $imagePath = storage_path('app/' . $photo->image_url);
                    if (file_exists($imagePath)) {
                    $imageSize = getimagesize($imagePath);
                    if ($imageSize !== false) {
                    echo 'Kích thước hình ảnh: ' . $imageSize[0] . ' x ' . $imageSize[1] . ' pixel';
                    }
                    } else {
                    ...
                    <div class="d-flex align-items-center author">
                        <div class="photo">
                            ...
                            <img src="{{ asset('/storage/' . $photo->user->avatar) }}" alt="{{ $photo->user->username }}" class="img-fluid">
                            @else
                            <img src="/home/assets/img/favicon.png" alt="Default Avatar" class="img-fluid">
                            @endif
                        </div>
                        <div class="name">
                    ...
                    <a href="{{ route('postEdit', ['id' => $photo->id]) }}" class="btn btn-warning"><i class="bi bi-pencil-square"></i> Sửa</a>
                    <button class="btn btn-danger delete-post-btn" data-id="{{ $photo->id }}"><i class="bi bi-trash-fill"></i> Xóa</button>
                    @endif
                    ...
                    <div class="btn-group" role="group">
                        @if($photo->status == 0)
                        <a href="{{ asset('/storage/' . $photo->image_url) }}" download="image.jpg" id="downloadBtn" class="btn btn-primary" data-photo-id="{{ $photo->id }}"><i class="bi bi-download"></i> Tải hình ảnh này</a>
                        @endif
                        <a class="btn btn-info btn-share" data-photo-id="{{ $photo->id }}"><i class="bi bi-share"></i> Chia sẻ</a>
                    </div>
                    @else
                    @if($photo->status == 0)
                    <div class="btn-group" role="group">
                        <button onclick="showLoginAlert()" class="btn btn-warning"><i class="bi bi-exclamation-triangle"></i> Đăng nhập để tải xuống</button>
                        <button onclick="showLoginAlert()" class="btn btn-info" data-photo-id="{{ $photo->id }}"><i class="bi bi-share"></i> Đăng nhập để chia sẻ</button>
                    </div>
                    @endif
                    @endif
