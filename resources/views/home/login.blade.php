                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">{{ __('Đăng nhập') }}</h5>
                                    </div>
                                    ...
                                    <form id="loginForm" class="row g-3" method="POST" action="{{route('postLogin')}}" novalidate>
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">{{ __('Đăng nhập') }}</button>
                                        </div>
                                        <div class="col-12">
                                            <p class="small mb-0">Bạn chưa có tài khoản? <a href="{{route('home.register')}}">Tạo tài khoản</a></p>
                                        </div>
                                        <div class="col-12">
                                            <p class="small mb-0">Quên mật khẩu? <a href="{{ route('forgot-password')}}">Nhấn vào đây</a></p>
                                        </div>
                                    </form>
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'Mật khẩu và địa chỉ email không đúng !',
                        html: errorMessage,
                    });
                }
            });
