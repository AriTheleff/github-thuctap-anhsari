    ...
    <div class="row">
      <div class="col-md-9 post-content" data-aos="fade-up">
        ...
        <div class="single-post">
          <div class="post-meta"><span class="date">Thời gian</span> <span class="mx-1">&bullet;</span> <span>{{$post->created_at}}</span></div>
          <h1 class="mb-5">{{$post->title}}</h1>
          <figure class="my-6">
            <img src="{{ asset('/storage/' . $post->image_url) }}" alt="" class="post-image img-fluid @if($post->status == 1) copyrighted @endif">
          </figure>


          <h5 class="mb-5"> {{$post->description}}</h5>
          @php
          $imagePath = storage_path('app/' . $post->image_url);
                ...
                <div class="reply d-flex mb-4">
                  <div class="flex-shrink-0">
                    <div class="photo">
                      ...
                      <img src="{{ asset('/storage/' . $comment->user->avatar) }}" alt="{{ $comment->user->username }}" class="img-fluid icon-size">
                      @else
                      <img src="/home/assets/img/favicon.png" alt="Default Avatar" class="img-fluid icon-size">
                      @endif
                    </div>
                  </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-12 mb-3">
                <textarea id="commentContent" class="form-control" name="content" cols="10" rows="10"></textarea>
