                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Gửi Email</h5>
                                    </div>
                                    ...
                                    <form class="row g-3" method="POST" id="emailForm">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">Gửi mail</button>
                                        </div>
                                    </form>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#emailForm').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("admin.send.reset.link.email") }}',
                    data: {
                        email: email,
                        _token: _token
                    },
