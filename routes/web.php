...
Route::get('/profile/edit', [Home_controller::class,'editProfile'])->name('profile.edit');
Route::post('/profile/update',[Home_controller::class,'updateProfile'])->name('profile.update');
